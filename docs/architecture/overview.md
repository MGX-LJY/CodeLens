...
CodeLens 是专为Claude Code设计的MCP（Model Context Protocol）协作平台和智能文档生成助手。通过四层文档架构和26个专业模板系统，CodeLens为AI驱动的项目文档生成提供完整的信息基础设施和标准化模板资源。

## 核心设计理念

🎯 **AI协作优先**: 专为Claude Code优化的信息提供与模板服务  
🏗️ **分层架构设计**: 四层文档体系，覆盖从文件到架构的完整文档需求  
🚀 **专业标准**: 26个专业模板，满足文档质量要求  
🔧 **模块化设计**: 独立可维护的模板组织，易于扩展和定制  
📊 **可观测性**: 完整日志系统，全流程操作追踪和性能监控
...
- **日志系统**: 完整可观测性 + 异步写入 + 文件轮转

## 四层文档架构模式

CodeLens 设计了**四层分级文档架构**，每层专注特定范围和深度的文档生成：
