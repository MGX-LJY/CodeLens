...
CodeLens 0.5.3 是一个专为Claude Code设计的MCP（Model Context Protocol）协作服务器。通过四层文档架构和16个核心模板系统，CodeLens为Claude Code提供结构化项目信息、标准化文档模板和完整验证服务，实现高效的项目文档理解与生成。
...
### 🚀 核心服务架构
- **TemplateServiceV05**: 16个核心模板管理，支持按层级/类型/名称查询
