...
CodeLens 0.5.3 是一个专为Claude Code设计的MCP（Model Context Protocol）协作服务器。通过四层文档架构和18个核心模板系统，CodeLens为Claude Code提供结构化项目信息、标准化文档模板和完整验证服务，实现高效的项目文档理解与生成。

## 核心特性

📚 **18个核心模板系统**：覆盖架构、模块、文件、项目四个文档层级
📊 **四层文档架构**：系统化的分层文档生成策略
...
**当前版本**: v0.5.3 (18个核心模板系统)

**✅ 核心功能特性**:
- ✅ **核心模板库** - 18个核心模板，覆盖主要文档需求
...
CodeLens 0.5.3 精简了四层文档架构，每层专注特定范围的文档生成：

```
🏛️ 架构层 (Architecture) - 6个模板
├── 系统架构概述、技术栈分析、数据流设计
├── 系统架构图、组件图、部署架构图
...
### 🚀 核心服务架构
- **TemplateServiceV05**: 18个核心模板管理，支持按层级/类型/名称查询
