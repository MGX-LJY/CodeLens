...
CodeLens 0.5.0 是一个专为Claude Code设计的企业级MCP（Model Context Protocol）协作服务器。通过革命性的四层文档架构和26个专业模板系统，CodeLens为Claude Code提供结构化项目信息、标准化文档模板和完整验证服务，实现高效的项目文档理解与生成。
...
🎯 **Claude Code深度集成**：专为AI协作优化的信息提供服务
📈 **企业级可观测性**：结构化日志、性能监控、文件轮转
...
**当前版本**: v0.5.0 (26个专业模板系统)

🎉 **v0.5.0 重大更新**:
- 🚀 **26个专业模板系统** - 四层架构，覆盖企业级文档需求
- 📁 **模块化模板组织** - 独立文件结构，便于维护扩展
- 🏗️ **架构层模板** (7个) - 系统概述、技术栈、数据流、设计模式等
- 🧩 **模块层模板** (6个) - 模块总览、依赖关系、API接口、业务流程等  
- 📄 **文件层模板** (5个) - 文件摘要、类分析、函数目录、算法分解等
- 📈 **项目层模板** (8个) - README、变更日志、路线图、贡献指南等

**✅ 核心功能特性**:
- ✅ **企业级模板库** - 26个专业模板，满足不同文档需求
- ✅ **智能模板服务** - 按层级、类型、名称灵活查询模板
- ✅ **模板格式化引擎** - 支持变量替换和内容验证  
- ✅ **完整MCP服务器** - 生产就绪的协议服务器实现
- ✅ **三核心MCP工具** - doc_scan, template_get, doc_verify
- ✅ **企业级日志系统** - 结构化日志、文件轮转、性能监控
